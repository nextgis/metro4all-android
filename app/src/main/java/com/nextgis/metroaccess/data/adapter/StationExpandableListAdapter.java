...
package com.nextgis.metroaccess.data.adapter;
...
import com.nextgis.metroaccess.ui.activity.LimitationsActivity;
import com.nextgis.metroaccess.ui.activity.MainActivity;
...
import com.nextgis.metroaccess.ui.activity.StationImageActivity;
import com.nextgis.metroaccess.ui.activity.StationMapActivity;
...
//                    imm.hideSoftInputFromWindow(view.getRootView().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
                    ...
                    itemLayout.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            mDropdown.dismiss();
                            Intent intentView = new Intent(parentActivity, StationImageActivity.class);
