...
import com.nextgis.metroaccess.data.adapter.ButtonListAdapter;
	...
	@Override
	  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (isCityChanged) {
            ...
            PreferencesActivity.clearRecent(mPreferences);
        }
		...
		new Thread() {
			...
			public void run() {
				...
				if(shortest_paths_list.size() == 0){
			        ...
			        Intent intentView = new Intent(MainActivity.this, RoutingActivity.class);
